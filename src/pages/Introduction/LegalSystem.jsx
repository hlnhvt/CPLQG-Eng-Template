...
const LegalSystem = () => {
  ...
  return (
    <div className="font-sans min-h-screen flex flex-col bg-slate-50 selection:bg-blue-200 scroll-smooth">
      ...
      <section className="bg-gradient-to-br from-[#0b2447] via-[#123b7a] to-[#2a458d] text-white py-24 px-4 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10 flex flex-col items-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-extrabold mb-6 drop-shadow-lg tracking-tight">
            Vietnamese <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-red-300">Legal System</span>
          </h1>

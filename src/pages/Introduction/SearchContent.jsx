...
const SearchContent = () => {
  ...
  return (
    <div className="font-sans min-h-screen flex flex-col bg-[#fdfdfd] selection:bg-blue-200">
      ...
      <section className="bg-gradient-to-b from-[#0b2447] to-[#163a70] text-white pt-16 pb-24 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h1 className="text-3xl md:text-5xl font-extrabold mb-8 tracking-tight drop-shadow-md">
            Global <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-indigo-200">Search Engine</span>
          </h1>

...
const About = () => {
  ...
  return (
    <AboutLayout>
      ...
      <section className="relative bg-[#0b2447] text-white py-28 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center flex flex-col items-center">
          <div className="w-24 h-24 bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center p-3 shadow-2xl mb-8 border border-white/20 transform hover:scale-105 transition-transform duration-500">
             <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a3/Emblem_of_Vietnam.svg/1200px-Emblem_of_Vietnam.svg.png" alt="Emblem of Vietnam" className="w-16 h-16 object-contain drop-shadow-md" />
          </div>

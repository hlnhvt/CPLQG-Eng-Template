...
const Contact = () => {
  ...
  return (
    <div className="font-sans min-h-screen flex flex-col bg-slate-50 selection:bg-blue-200">
      ...
      <section className="relative bg-[#051124] text-white py-24 px-4 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-slate-50 via-transparent to-[#051124]/90"></div>
        
        <div className="max-w-6xl mx-auto text-center relative z-10 pt-10">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-blue-400/30 bg-blue-500/10 text-blue-300 font-semibold tracking-widest uppercase mb-6 backdrop-blur-sm">
             <Map className="w-4 h-4" />
             Get in Touch
          </div>
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold mb-6 tracking-tight drop-shadow-xl text-slate-900">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-indigo-300">Contact</span> Us
          </h1>

...
const OpenLetter = () => {
  return (
    <div className="font-sans min-h-screen flex flex-col bg-slate-50 selection:bg-blue-200">
      ...
      <section className="relative bg-[#0b2447] text-white py-20 px-4 overflow-hidden shadow-2xl">
        {/* Abstract Background */}
        <div className="absolute inset-0 opacity-20 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] mix-blend-overlay"></div>
        <div className="absolute -top-40 -right-40 w-96 h-96 bg-blue-500 rounded-full mix-blend-multiply filter blur-[100px] opacity-50 animate-pulse"></div>
        <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-indigo-500 rounded-full mix-blend-multiply filter blur-[100px] opacity-50 animate-pulse" style={{ animationDelay: '2s' }}></div>
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight drop-shadow-lg">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-indigo-200">National Legal Portal</span>
          </h1>
        </div>
      </section>
          ...
          <div className="p-8 md:p-16 lg:p-20 relative z-10">
            ...
            <footer className="mt-20 pt-10 border-t border-gray-100 flex flex-col md:flex-row items-center md:items-end justify-between gap-10">
               <div className="flex items-center gap-6 order-2 md:order-1">
                 ...
                 <div>
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/Quy%E1%BB%B1t_%C4%90%E1%BA%A1i.svg/800px-Quy%E1%BB%B1t_%C4%90%E1%BA%A1i.svg.png" alt="Official Seal" className="w-16 h-16 object-contain opacity-20 mix-blend-multiply" />
                 </div>
               </div>
               ...
               <div className="text-center md:text-right order-1 md:order-2">
                  ...
                  <div className="mb-4 transform hover:scale-105 transition-transform origin-right duration-300 flex justify-center md:justify-end">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/d/dd/Signature_of_Nguyen_Phu_Trong.svg" alt="Signature" className="h-[4.5rem] object-contain drop-shadow-sm filter contrast-125" />
                  </div>

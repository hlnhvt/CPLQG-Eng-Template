...
const LegalFAQ = () => {
  ...
  return (
    <div className="font-sans min-h-screen flex flex-col bg-[#fdfdfd] selection:bg-indigo-200">
      ...
      <section className="bg-slate-900 border-b border-slate-800 pt-20 pb-28 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center justify-center p-3 sm:p-4 bg-white/5 backdrop-blur-md rounded-full mb-8 border border-white/10 shadow-2xl">

...
const Vision = () => {
  ...
  return (
    <div className="font-sans min-h-screen flex flex-col bg-slate-50 selection:bg-blue-200">
      ...
      <section className="relative bg-[#051124] text-white py-32 overflow-hidden flex items-center justify-center min-h-[70vh]">
         {/* Parallax Background Video/Image Concept */}
         <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=2000&auto=format&fit=crop')] bg-cover bg-center opacity-30 mix-blend-screen scale-105 animate-[pulse_20s_ease-in-out_infinite]"></div>
         <div className="absolute inset-0 bg-gradient-to-b from-[#051124]/80 via-transparent to-[#051124]"></div>
         
         <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
            {/* Vision Block */}
            <div className="mb-20 transform -translate-y-4 animate-[fadeIn_1s_ease-out_forwards]">
              ...
              <h1 className="text-6xl md:text-8xl font-black uppercase tracking-tighter mb-10 text-transparent bg-clip-text bg-gradient-to-b from-white via-blue-100 to-blue-300 drop-shadow-2xl">
                VISION
              </h1>
              <p className="text-2xl md:text-4xl font-light leading-relaxed text-blue-50 max-w-4xl mx-auto italic relative">
                <span className="absolute -top-10 -left-10 text-8xl text-blue-500/30">"</span>

...
const Functions = () => {
  ...
  return (
    <div className="font-sans min-h-screen flex flex-col bg-slate-50 selection:bg-blue-200">
      ...
      <section className="relative bg-[#0b2447] text-white py-24 px-4 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6 tracking-tight drop-shadow-xl">
            Functions & <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-indigo-200">Responsibilities</span>
          </h1>

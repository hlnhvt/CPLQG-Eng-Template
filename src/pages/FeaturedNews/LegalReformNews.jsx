    ...
    <div className="font-sans min-h-screen flex flex-col bg-slate-50">
      ...
      <div className="bg-white border-b border-gray-200 shadow-sm relative overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-6 relative z-10">
          <div className="flex items-center gap-2 text-sm text-gray-500 mb-2">
            ...
            <ChevronRight size={14} />
            <span className="text-gray-800 font-medium">Legal Reform News</span>
          </div>
          <h1 className="text-3xl md:text-4xl font-extrabold text-[#1e3a8a] tracking-tight">Legal Reform News</h1>
        </div>
      </div>
      ...
      <main className="flex-grow max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-[70%]">
          ...
          <Link to="/legal-reform-news/1" className="block relative rounded-2xl overflow-hidden group mb-8 shadow-md">
            ...
            <div className="absolute bottom-0 left-0 p-6 md:p-8 w-full z-10">
              <span className="inline-block px-3 py-1 bg-sky-600 text-white text-xs font-bold uppercase tracking-wider rounded mb-3">Investment Law</span>
              ...
              <div className="flex items-center gap-4 text-xs text-gray-300 font-medium">
                ...
                <span className="flex items-center gap-1.5"><Calendar size={12} /> 12/03/2026</span>
              </div>
            </div>
          </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {[
              {
                id: 2,
                title: 'Comprehensive reform of administrative procedures in customs clearance',
                category: 'Trade',
                date: '08/03/2026',
                source: 'General Dept. of Customs',
                image: 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?auto=format&fit=crop&q=80&w=600'
              },
              {
                id: 3,
                title: 'New regulations on corporate bond issuance to enhance market transparency',
                category: 'Finance',
                date: '02/03/2026',
              ...
              {
                id: 4,
                title: 'Amending the Land Law: Decentralizing land pricing to local authorities',
              ...
              <Link to={`/legal-reform-news/${article.id}`} key={article.id} className="group bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-all flex flex-col">
                <div className="aspect-[4/3] bg-gray-200 relative overflow-hidden">
                  <span className="absolute top-2 left-2 z-10 bg-sky-900/80 text-white text-[10px] uppercase font-bold px-2 py-0.5 rounded backdrop-blur-sm">
                    {article.category}
                  </span>
                ...
                <div className="p-4 flex flex-col flex-grow">
                  ...
                  <div className="flex items-center justify-between text-[11px] text-gray-500 font-medium">
                    <span className="truncate max-w-[90px]">{article.source}</span>
          ...
          <div className="space-y-6 mb-12">
            {[
              {
                id: 5,
                title: 'Digital transformation in judicial record issuance',
                abstract: 'Citizens can now obtain electronic judicial records via the national public service portal within 24 hours, eliminating the need for physical paperwork.',
              ...
              {
                id: 6,
                title: 'New tax relief measures for SMEs approved by the Government',
                abstract: 'A sweeping reform package will reduce corporate income tax by 2% for small and medium enterprises applying green technologies.',
                category: 'Taxation',
                date: '15/02/2026',
              ...
              {
                id: 7,
                title: 'Strengthening intellectual property enforcement on digital platforms',
                abstract: 'Decree guiding the IP Law introduces stricter penalties for copyright infringement on social networks and cross-border platforms.',
                category: 'Intellectual Property',
                date: '10/02/2026',
                source: 'Ministry of Science & Tech',
                image: 'https://images.unsplash.com/photo-1589391886645-d51941baf7fb?auto=format&fit=crop&q=80&w=400'
              }
            ].map((article) => (
              <div key={article.id} className="bg-white border border-gray-200 rounded-xl p-4 flex flex-col md:flex-row gap-5 shadow-sm hover:shadow-md transition-shadow group">
                <Link to={`/legal-reform-news/${article.id}`} className="flex-shrink-0 relative rounded-lg overflow-hidden w-full md:w-[240px] aspect-[16/9] md:aspect-[4/3]">
                ...
                <div className="flex flex-col flex-grow min-w-0">
                   <Link to={`/legal-reform-news/${article.id}`} className="text-xl font-bold text-gray-900 group-hover:text-blue-600 transition-colors mb-2 leading-snug">
                     {article.title}
                   </Link>
                   ...
                   <div className="mt-auto flex flex-wrap items-center gap-4 text-xs font-medium text-gray-500 border-t border-gray-100 pt-3">
                      <span>Source: <span className="text-gray-900">{article.source}</span></span>
        ...
        <aside className="w-full lg:w-[30%] flex flex-col gap-6 hide-scrollbar">
           ...
           <a href="#" className="block rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
             <img src="https://images.unsplash.com/photo-1486325212027-8081e485255e?auto=format&fit=crop&q=80&w=600" alt="Tech Hub Banner" className="w-full object-cover" />
           </a>
           ...
           <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
              ...
              <div className="p-5 flex flex-col gap-4">
                 {[
                   { title: 'Digital transformation in judicial record issuance', date: '20/02/2026', image: 'https://images.unsplash.com/photo-1531297484001-80022131f5a1?auto=format&fit=crop&q=80&w=200' },
                   { title: 'New tax relief measures for SMEs approved by the Government', date: '15/02/2026', image: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?auto=format&fit=crop&q=80&w=200' },
                   { title: 'Strengthening intellectual property enforcement', date: '10/02/2026', image: 'https://images.unsplash.com/photo-1589391886645-d51941baf7fb?auto=format&fit=crop&q=80&w=200' },
                   { title: 'Changes in visa policies for foreign investors', date: '05/02/2026', image: 'https://images.unsplash.com/photo-1436491865332-7a61a109cc05?auto=format&fit=crop&q=80&w=200' },
                 ].map((item, idx) => (
                   <Link key={idx} to={`/legal-reform-news/${idx+10}`} className="flex gap-3 group">
           ...
           <div className="bg-white rounded-xl border border-gray-200 text-center p-6 shadow-sm relative overflow-hidden">
              ...
              <h3 className="font-bold text-gray-900 mb-2 uppercase tracking-wide text-sm">Feedback & Support</h3>
              <p className="text-xs text-gray-600 mb-5 leading-relaxed">
                 We Are Always Listening & Responding. Send us your concerns regarding recent legal reforms.
              </p>
              <div className="flex flex-col gap-3">
                 ...
                 <button className="w-full bg-amber-500 hover:bg-amber-600 text-white py-2.5 rounded-lg text-sm font-bold flex justify-center items-center gap-2 transition-colors">
                   <Phone size={16} /> Call: +84 24 1234 5678
                 </button>
              </div>
           </div>
...
export default LegalReformNews;

          ...
          <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] w-full max-w-lg p-8 md:p-12 border border-slate-100 text-center relative overflow-hidden">
             ...
             <div className="flex flex-col sm:flex-row gap-4">
                <button 
                  ...
                  className="flex-1 bg-red-600 hover:bg-red-700 text-white font-bold py-3.5 rounded-xl transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2"
                >
                  <BellOff className="w-5 h-5" /> Confirm Unsubscribe
                </button>
                <Link 
                  to="/"
                  className="flex-1 bg-white hover:bg-slate-50 border-2 border-slate-200 text-slate-600 font-bold py-3.5 rounded-xl transition-colors flex items-center justify-center"
                >
                  Cancel
                </Link>
             </div>
